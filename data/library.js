// D&D Asset Library
// Edit this file to add your own spells, features, resources, and equipment.
// This is a JS wrapper around the library data so it works with file:// protocol.
window.LIBRARY_DATA = {
  "spells": [
    {
      "name": "Fireball",
    ...
    },
    {
      ...
      "cantripUpgrade": "The spell creates more than one beam when you reach higher levels: two beams at 5th level, three beams at 11th level, and four beams at 17th level."
    },
    {
      "name": "Cure Wounds",
      "level": 1,
    ...
    },
    {
      ...
      "source": "Player's Handbook",
      "description": "This spell is a minor magical trick that novice spellcasters use for practice. You create one of the following magical effects within range: a harmless sensory effect, light or snuff a candle/torch/small campfire, clean or soil an object no larger than 1 cubic foot, chill/warm/flavor up to 1 cubic foot of nonliving material, make a color mark appear on a surface for 1 hour, or create a trinket or an illusory image that fits in your hand and lasts until the end of your next turn.",
      "cantripUpgrade": ""
    },
    {
      "name": "Counterspell",
  ...
  "features": [
    ...
    },
    {
      ...
      "movementCost": 0,
      "resourceCost": null,
      "requirements": "Finesse or ranged weapon; advantage or ally adjacent to target",
    ...
    },
    {
      ...
      "movementCost": 0,
      "resourceCost": null,
      "requirements": "Not wearing armor or shield",
    ...
    },
    {
      ...
      "isMovement": false,
      "movementCost": 0,
      "resourceCost": "2 Ki Points",
      "requirements": "Must have taken the Attack action",
      "description": "Immediately after you take the Attack action on your turn, you can spend 2 ki points to make two unarmed strikes as a bonus action."
    },
    {
      "name": "Wild Shape",
      "sourceType": "class",
    ...
    },
    {
      ...
      "isMovement": false,
      "movementCost": 0,
      "resourceCost": "1 Bardic Inspiration use",
      "requirements": "",
  ...
  "resources": [
    {
      ...
      "source": "Monk",
      "maximum": 0,
      "description": "Ki points fuel monk abilities. You regain all spent ki points when you finish a short or long rest. The number of ki points equals your Monk level."
    },
    {
      "name": "Sorcery Points",
      "sourceType": "class",
      "source": "Sorcerer",
      "maximum": 0,
      "description": "You have sorcery points equal to your Sorcerer level. You regain all spent sorcery points when you finish a long rest."
    },
    {
      "name": "Bardic Inspiration",
      "sourceType": "class",
      "source": "Bard",
      "maximum": 0,
      "description": "Bardic Inspiration uses equal to your Charisma modifier (minimum of 1). You regain expended uses when you finish a long rest. At 5th level you regain them on a short rest."
    },
    {
      "name": "Wild Shape",
      "sourceType": "class",
      "source": "Druid",
      "maximum": 2,
      "description": "You can use Wild Shape twice. You regain expended uses when you finish a short or long rest."
    },
    {
      "name": "Lay on Hands",
      "sourceType": "class",
    ...
    },
    {
      ...
      "source": "Cleric",
      "maximum": 1,
      "description": "You can channel divine energy to fuel magical effects. You start with two effects: Turn Undead and an effect determined by your domain. You regain expended uses when you finish a short or long rest."
    },
    {
      "name": "Action Surge",
      "sourceType": "class",
    ...
    {
      "name": "Sneak Attack (per turn)",
      "sourceType": "class",
      "source": "Rogue",
      "maximum": 1,
      "description": "Tracks usage of Sneak Attack — can be used once per turn. Reset each turn."
    },
    {
      "name": "Superiority Dice",
      "sourceType": "class",
      "source": "Battle Master Fighter",
      "maximum": 4,
      "description": "You have four superiority dice, which are d8s. A superiority die is expended when you use it. You regain all your expended superiority dice when you finish a short or long rest."
    }
  ],
  "equipment": [
    {
      ...
      "weight": "3 lb.",
      "cost": "15 gp",
      "description": "Versatile (1d10). A versatile weapon can be used with one or two hands. Damage: 1d8 slashing."
    },
    {
      "name": "Shortsword",
      "type": "Martial Weapon",
      "weight": "2 lb.",
      "cost": "10 gp",
      "description": "Finesse, light. Damage: 1d6 piercing."
    },
    {
      "name": "Dagger",
      "type": "Simple Weapon",
      "weight": "1 lb.",
      "cost": "2 gp",
      "description": "Finesse, light, thrown (range 20/60). Damage: 1d4 piercing."
    },
    {
      "name": "Handaxe",
      "type": "Simple Weapon",
      "weight": "2 lb.",
      "cost": "5 gp",
      "description": "Light, thrown (range 20/60). Damage: 1d6 slashing."
    },
    {
      "name": "Longbow",
      "type": "Martial Weapon",
      "weight": "2 lb.",
      "cost": "50 gp",
      "description": "Ammunition (range 150/600), heavy, two-handed. Damage: 1d8 piercing."
    },
    {
      "name": "Leather Armor",
      "type": "Light Armor",
      "weight": "10 lb.",
      "cost": "10 gp",
      "description": "Base AC: 11 + Dexterity modifier. The breastplate and shoulder protectors of this armor are made of leather that has been stiffened by being boiled in oil."
    },
    {
      "name": "Chain Mail",
      "type": "Heavy Armor",
      "weight": "55 lb.",
      "cost": "75 gp",
      "description": "Base AC: 16. Disadvantage on Stealth. Str 13 required. Made of interlocking metal rings, chain mail includes a layer of quilted fabric worn underneath the mail to prevent chafing and to cushion the impact of blows."
    },
    {
      "name": "Shield",
      "type": "Armor",
      "weight": "6 lb.",
      "cost": "10 gp",
      "description": "+2 AC. A shield is made from wood or metal and is carried in one hand. Wielding a shield increases your Armor Class by 2."
    },
    {
      "name": "Healing Potion",
      "type": "Consumable",
    ...
    },
    {
      ...
      "weight": "5 lb.",
      "cost": "2 gp",
      "description": "A backpack can hold 1 cubic foot / 30 pounds of gear. You can also strap items, such as a bedroll or a coil of rope, to the outside of a backpack."
    },
    {
      "name": "Torch",
      "type": "Adventuring Gear",
